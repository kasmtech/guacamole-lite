...
class GuacdClient {
    ...
    sendHandshakeReply() {
        ...
        this.sendOpCode(['audio'].concat(this.clientConnection.connectionSettings.connection.audio || []));
        this.sendOpCode(['video'].concat(this.clientConnection.connectionSettings.connection.video || []));
